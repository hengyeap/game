  ...
  <div>
    <div class="lottery">
      <div @click="start()" class="lottery-start">
        <img class="start-icon-img"
             :src="'https://resource.yuedaoec.com/assets/november-lottery/{}/start-icon.png'.replace('{}',platformInner)"/>
      </div>
      <div class="light-icon">
        <img class="light-icon-img" v-show="light"
             :src="'https://resource.yuedaoec.com/assets/november-lottery/{}/light-icon1.png?11'.replace('{}',platformInner)"/>
      </div>
    ...
    <!--            </div>-->
    <!--        </div>-->
    <canvas width="1396" height="1370" style="position: fixed;top: -1000000px;right: 0px;width:375px; height:450px"
            ref="shareImg"></canvas>
    ...
    export default {
                ...
                gifts: [
                    {
                        ...
                        img: 'diamond.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_diamond.png'
                    },
                    {
                        key: '1',
                        name: 'one',
                        img: 'one.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_one.png'
                    },
                    {
                        key: '2',
                        name: 'two',
                        img: 'two.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_two.png'
                    },
                    {
                        key: '3',
                        name: 'three',
                        img: 'three.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_three.png'
                    },
                    {
                        key: '4',
                        name: 'four',
                        img: 'four.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_four.png'
                    }, {
                        key: '5',
                        name: 'five',
                        img: 'five.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_five.png'
                    }, {
                        key: '6',
                        name: 'six',
                        img: 'six.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_six.png'
                    },{
                        key: '7',
                        name: 'seven',
                        img: 'seven.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_seven.png'
                    },
                    {
                        key: '9',
                        name: 'thanks',
                        img: 'thanks.png',
                        prizeShowImg: 'https://resource.yuedaoec.com/assets/november-lottery/{}/prize_thanks.png',
        ...
        methods: {
            ...
            start() {
                ...
                const params = {
                    type: 'get',
                    url: 'double-eleven/2020/11/rotate',
                    query: {
                        ...
                        if (response.success) {
                            ...
                            if (
                                ...
                                this.loadImg(
                                    ...
                                    img => {
                                        ctx.drawImage(img, 0, 0, 1396, 1370);
                                        ctx.save();
                                        ctx.stroke();
