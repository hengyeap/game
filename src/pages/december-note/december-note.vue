      ...
      <div v-if="status == 1">
        ...
        <div v-else>
          <div v-for="(log,index) in logs"
            ...
            <div class="word-chance">{{log.orderCode ? i18n[platform].orderCode + log.orderCode : ''}} {{log.qty == 1?
...
<!--      <div v-if="status == 1">-->
<!--        <div>-->
<!--          <div v-for=" item in logs"  class="word">-->
<!--            <div class="word-chance">{{i18n[platform].gainRecordsTimes.replace('{}',item.qty) +"，"+-->
<!--              i18n[platform].gainRecordsAmount.replace('{}',item.amount)}}-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
    ...
    export default create({
            ...
            return {
                ...
                i18n: {
                    ...
                    tingo2o: {
                        ...
                        one: 'iphone12',
                        two: '爱马仕围巾',
                        three: '薰衣草面膜单片5片+薰衣草面膜盒装1盒',
                        four: '80元代金券，（拆分为30+50）',
                        five: '30元代金券，（面值30/张）',
                        six: '红包8.8元',
                        seven: '20元代金券',
                        thanks: '谢谢参与',
                    ...
                    newtingmalaysia: {
                        title: 'Event Records',
                        quaLog: 'Golden Egg Smashing Qualification Record',
                        useLog: 'Golden Egg Smashing Record',
                        noQuaInfo: 'Not qualified for Golden Egg Smashing',
                        noUseLog: 'No Golden Egg Smashing record',
                        huawei: 'HUAWEI PHONE * 1',
                        mask: '1st Prize',
                        lipstick: '2nd Prize',
                        giftpackage: '3rd Prize',
                        diamond: 'Red Packet RM5300',
                        one: ' Red Packet RM530',
                        two: 'Red Packet RM53',
                        three: 'Red Packet RM5.3',
                        four: ' Red Packet RM1',
                        five: 'RM12 Voucher ',
                        six: 'Red Packet RM5',
                        seven: 'Voucher RM12',
                    ...
                    tingsingapore: {
                        ...
                        lipstick: '2nd Prize',
                        giftpackage: '3rd Prize',
                        diamond: 'Red Packet SGD1800',
                        one: 'Red Packet SGD180',
                        two: 'Red Packet SGD18',
                        three: 'Red Packet SGD1.8',
                        four: 'Red Packet SGD1',
                        five: 'SGD4 Voucher',
                        six: 'Red Packet SGD1.8',
                        seven: 'Voucher SGD4',
                        thanks: 'Sorry! No Prize won, thank you for participating!',
                        gainQuas: 'get Lucky Draw Entry {} Times',
                        gainQua: 'get Lucky Draw Entry {} Time',
        ...
        methods: {
            getQuaLogs() {
                const params = {
                    type: 'get',
                    url: 'double-eleven/2020/12/qua-logs',
                    userToken: true,
                    query: {
            ...
            getPrizeLogs() {
                const params = {
                    type: 'get',
                    url: 'double-eleven/2020/12/prize-logs',
                    userToken: true,
                    query: {
                        platform: this.platform
                    },
