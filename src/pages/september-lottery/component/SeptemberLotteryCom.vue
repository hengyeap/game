        ...
        <div class="lottery">
          ...
          <div class="light-icon">
            <img class="light-icon-img" v-show="light"
                 :src="'https://resource.yuedaoec.com/assets/september-lottery/{}/light-icon.png'.replace('{}',platformInner)"/>
          </div>
...
<!--            </div>-->
<!--        </div>-->
        <canvas width="750" height="668" style="position: fixed;top: -1000000px;right: 0px;width:375px; height:450px"
                ref="shareImg"></canvas>
    </div>
</template>
<script>
    ...
    export default {
                ...
                gifts: [
                    {
                        ...
                        img: 'diamond.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_diamond.png'
                    },
                    {
                        key: '1',
                        name: 'one',
                        img: 'one.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_one.png'
                    },
                    {
                        key: '2',
                        name: 'two',
                        img: 'two.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_two.png'
                    },
                    {
                        key: '3',
                        name: 'three',
                        img: 'three.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_three.png'
                    },
                    {
                        key: '4',
                        name: 'four',
                        img: 'four.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_four.png'
                    }, {
                        key: '5',
                        name: 'five',
                        img: 'five.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_five.png'
                    }, {
                        key: '6',
                        name: 'six',
                        img: 'six.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_six.png'
                    },{
                        key: '7',
                        name: 'seven',
                        img: 'seven.png',
                        prizeShowImg:
                            'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_seven.png'
                    },
                    {
                        key: '9',
                        name: 'thanks',
                        img: 'thanks.png',
                        prizeShowImg: 'https://resource.yuedaoec.com/assets/september-lottery/{}/prize_thanks.png',
        ...
        methods: {
            ...
            start() {
                ...
                const params = {
                    type: 'get',
                    url: 'double-eleven/2020/09/rotate',
                    query: {
