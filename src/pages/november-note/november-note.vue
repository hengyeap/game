    ...
    export default create({
            ...
            return {
                ...
                i18n: {
                    ...
                    newtingmalaysia: {
                        ...
                        two: 'Hermes Scarf',
                        three: 'iphone12',
                        four: 'Red Packet RM530',
                        five: 'Red Packet RM53',
                        six: 'Red Packet RM5',
                        seven: 'Voucher RM12',
                    ...
                    tingsingapore: {
                        ...
                        two: 'Hermes Scarf',
                        three: 'iphone12',
                        four: 'Red Packet SGD180',
                        five: 'Red Packet SGD18',
        ...
        methods: {
            getQuaLogs() {
                const params = {
                    type: 'get',
                    url: 'double-eleven/2020/11/qua-logs',
                    userToken: true,
                    query: {
            ...
            getPrizeLogs() {
                const params = {
                    type: 'get',
                    url: 'double-eleven/2020/11/prize-logs',
                    userToken: true,
                    query: {
                        platform: this.platform
                    },
